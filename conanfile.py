...
class FossilCrypticConan(ConanFile):
    name = "fossil_cryptic"
    version = "0.1.1"
    license = "MPL-2.0"
    author = "Fossil Logic <michaelbrockus@gmail.com>"
    url = "https://github.com/fossillogic/fossil-cryptic"
    description = "Fossil Cryptic is a lightweight, portable cryptography library written in pure C with zero external dependencies."
    topics = ("c", "2auth", "security", "hash", "cpp", "meson", "conan-recipe", "mesonbuild", "ninja-build")
    ...
    def package(self):
        ...
        copy(self, "*.h",
             src="code/logic/fossil/cryptic",
             dst=os.path.join(self.package_folder, "include", "fossil", "cryptic"))

    def package_info(self):
        """Set information for consumers of the package"""
        self.cpp_info.libs = ["fossil_cryptic"]
